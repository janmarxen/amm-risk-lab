...
Usage:
    python run_data_download.py --api_key <API_KEY> --subgraph_id <SUBGRAPH_ID> --start_date <YYYY-MM-DD> --end_date <YYYY-MM-DD> [--output_hdf5 <PATH>] [--main_pool_address <ADDR>] [--n_pools <N>]
...
Arguments:
    ...
    --output_hdf5: (Optional) Path to output HDF5 file (default: /p/scratch/training2529/uniswap_pools_data.h5).
...
def main():
    ...
    parser.add_argument('--output_hdf5', type=str, required=False, 
                       default="/p/scratch/training2529/uniswap_pools_data.h5", 
                       help="Path to output HDF5 file for raw pool data.")
